...
class Eggs extends StatefulWidget {
  ...
  @override
  _EgssState createState() => _EgssState();
}

class _EgssState extends State<Eggs> {
  List listOfFacts = [];
  Future fetchData() async {
    http.Response response;
    const API_URL = 'https://precision-air.herokuapp.com/egss.php';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('EGGS',style: TextStyle(color: Colors.white),),
        centerTitle: true,
      ),
      // drawer: Drawer(
      //   child: Container(
